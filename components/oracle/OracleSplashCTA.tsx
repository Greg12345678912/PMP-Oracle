...
/** Full-width "Continue with Google" button for the Oracle splash.
 *  After OAuth the callback will route new users to /challenge/onboarding. */
export function OracleSplashCTA() {
  const handleSignIn = async () => {
    ...
    await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: {
        redirectTo: `${window.location.origin}/auth/callback?next=/challenge/onboarding`,
      },
    })
  }
